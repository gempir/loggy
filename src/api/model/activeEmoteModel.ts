 ...
 */
import type { ActiveEmoteModelActorId } from './activeEmoteModelActorId';
import type { ActiveEmoteModelData } from './activeEmoteModelData';
import type { ActiveEmoteFlagModel } from './activeEmoteFlagModel';
import type { EmoteId } from './emoteId';
import type { ActiveEmoteModelOriginId } from './activeEmoteModelOriginId';

export interface ActiveEmoteModel {
  /** @nullable */
  actor_id?: ActiveEmoteModelActorId;
  /** @nullable */
  data?: ActiveEmoteModelData;
  flags: ActiveEmoteFlagModel;
  id: EmoteId;
  name: string;
  /** @nullable */
  origin_id?: ActiveEmoteModelOriginId;
  timestamp: number;
}
